...
description: "产品上线雷达工作流：产品上线列表、功能风险分类、上线法律风险雷达、产品发布合规摘要。claude-for-legal-ZH/managed-agent-cookbooks/launch-radar 的 WorkBuddy 路由技能。"
---

# 产品上线雷达工作流 — claude-for-legal-ZH（WorkBuddy 适配）

本技能把原托管 Agent cookbook 转写为 WorkBuddy 工作流。

## 源文件

- Cookbook 根目录：`managed-agent-cookbooks/launch-radar`
- 先读：`managed-agent-cookbooks/launch-radar/README.md`
- Agent 蓝图：`managed-agent-cookbooks/launch-radar/agent.yaml`
- 引导示例：`managed-agent-cookbooks/launch-radar/steering-examples.json`
- 子 Agent 蓝图：`managed-agent-cookbooks/launch-radar/subagents`
